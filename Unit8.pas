...
form8.ADOQuery1.SQL.Text:='SELECT     Фамилия, Имя, Отчество, Должность, Телефон, Адрес '+
'FROM         dbo.Сотрудники   WHERE  Фамилия= '''+edit1.Text+'''';
//showmessage(form8.ADOQuery1.SQL.Text) ;
...
WordApplication1.Selection.TypeText('Таблица <Сотрудники>');
